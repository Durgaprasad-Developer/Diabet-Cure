      ...
      <div className="pt-20">
        ...
        <div className="flex justify-center space-x-4">
          <button
            ...
            className="border border-blue-600 text-blue-600 px-6 py-3 rounded-xl font-semibold text-base hover:bg-blue-50 transition duration-300 cursor-pointer"
          >
            Sign In
          </button>
          <button
            onClick={() => navigate("/signup")}
            className="bg-blue-600 text-white px-6 py-3 rounded-xl font-semibold text-base hover:bg-blue-700 transition duration-300 shadow-lg cursor-pointer"
          >
            Sign Up Free
          </button>
        </div>
